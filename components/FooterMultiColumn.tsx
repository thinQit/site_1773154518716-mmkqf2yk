...
export default function FooterMultiColumn({
  brand = 'IRON PULSE',
  description = 'Elite strength, conditioning, and recovery programs built to keep you moving with power.',
  columns = [],
  copyright,
      ...
      <div className="container mx-auto max-w-7xl px-4 py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-1">
            <h3 className="text-lg font-black uppercase tracking-wide">{brand}</h3>
