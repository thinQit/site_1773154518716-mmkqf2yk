...
export default function TestimonialsGrid({
  headline = 'Real Members. Real Transformations.',
  subheadline = 'Hear how our community built strength, confidence, and consistency.',
  testimonials = [],
              ...
              <Card key={i} className="border bg-background">
                <CardContent className="p-6">
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold uppercase text-foreground">{t.name}</p>
